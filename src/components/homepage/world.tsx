                                ...
                                <form onSubmit={handleSubmit} className="flex space-y-4 mx-auto justify-center">
                                    <div className="relative flex mt-8 h-10 w-full min-w-[200px] max-w-[24rem]">
                                        ...
                                        <input
                                            ...
                                            className="peer h-full w-full rounded-full border border-blue-gray-200 bg-transparent px-3 py-2.5 pr-20 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-blue-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                        />
